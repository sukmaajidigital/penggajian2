...
<html lang="en">
   <head>
      ...
      <title> Aplikasi Penggajian PT. ARIMBI</title>
      <!-- StyleSheets -->
   ...
   <body>
      ...
      <div class="Header" id="Home">
         <nav class="navbar fixed-top">
            <div class="container">
               <a class="navbar-brand" href="#">  Penggajian PT ARIMBI</a>
            ...
            <div class="layer">
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        <div>
                        <img src="<?php echo base_url(); ?>assets/img/Logo PT ARIMBI.png">
      ...
      <div class="Footer" id="Footer">
         <div class="container">
            <div class="row">
               ...
               <img src="<?php echo base_url(); ?>assets/img/Logo PT ARIMBI.png" height="80px">
            <span>| Penggajian 2024| 
               </div>
            </div>
         </div>
      </div>
